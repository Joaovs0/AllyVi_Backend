...
exports.create = async (request, response) => {
    try{
        const { nome, dataNasci, telefone, email, password} = request.body
        
        const paci = await paciService.create( nome, dataNasci, telefone, email, password)
...
exports.update = async(request, response) => {
    try{
        ...
        await paciService.update(id, nome, dataNasci, telefone, email, password)
